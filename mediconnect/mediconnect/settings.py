...
SECRET_KEY = 'django-insecure-!k#z*!c(lthx&^r%j@kwsm&lqyrs#o3x2za8+yc0v0-#zx$&j6'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # ← Yeh add karo
STATIC_ROOT = BASE_DIR / 'staticfiles'    # ← Yeh bhi add karo
